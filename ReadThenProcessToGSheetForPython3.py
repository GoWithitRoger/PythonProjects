import os, zipfile, re, urllib, ntpath
from urllib.request import urlopen

path_to_directory = input("Type path to directory on .docx files: ")
spreadsheet_name = input("Type a name for the spreadsheet (or use existing name):")
...
for filePath in files:
    ...
    myCalaisAPI_key = 'API KEY GOES HERE' ### enter your Calais API key before running this script
